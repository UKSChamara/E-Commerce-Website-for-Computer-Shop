...
<table width="200" border="0" align="center">
  <tbody>
    <tr>
      <td width="227" align="center"><a href="Shop.php"><button type="submit" name="btnsubmit" id="subbtn">Back</button></a></td>
	    <td width="227" align="center"><a href="Shop.php"><button type="submit" name="btnsubmit" id="subbtn">Continue Shoping</button></a></td>
    </tr>
  </tbody>
</table>
</a>
